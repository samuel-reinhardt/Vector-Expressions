...
class UserRoot extends Root {
	...
	protected function label(): string { return __( 'User', 'vector-expressions' ); }
	protected function description(): string { return __( 'Logged-in user — name, email, role…', 'vector-expressions' ); }
